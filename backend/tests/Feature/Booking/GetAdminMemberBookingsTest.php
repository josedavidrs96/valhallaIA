...
final class GetAdminMemberBookingsTest extends TestCase
{
    use RefreshDatabase;
    ...
    public function test_admin_can_get_member_bookings(): void
    {
        ...
        $response = $this->actingAs($admin, 'sanctum')
            ->getJson("/api/admin/members/{$memberData['memberId']}/bookings");
    ...
    public function test_member_cannot_access_admin_member_bookings(): void
    {
        $memberData  = $this->createMemberUser();
        $memberData2 = $this->createMemberUser('member2@gym.com');

        $response = $this->actingAs($memberData['user'], 'sanctum')
            ->getJson("/api/admin/members/{$memberData2['memberId']}/bookings");
