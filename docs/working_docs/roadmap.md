...
| [epic-booking-ux](epics/epic-booking-ux/requirements.md) | Reorganize booking views with tabs (upcoming / past / cancelled) and better UX | epic-booking-rules | ✅ Done |
...
- Done: epic-booking-ux — tabs Proximas/Pasadas/Canceladas en Mis Reservas, cards con countdown para proximas.
