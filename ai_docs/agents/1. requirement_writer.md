...
2. `/ai_docs/development_process/requirement_analysis_guide.md` - Requirement structure
...
Follow the structure in `/ai_docs/development_process/requirement_analysis_guide.md`
